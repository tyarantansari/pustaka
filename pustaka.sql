...
CREATE TABLE `buku` (
  ...
  `image` varchar(266) DEFAULT 'book-default-cover.jpg'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 'Statistika dengan Program Komputer', 1, 'Ahmad Kholiqul Amin', 'Deep Publish', 2014, '9786022809432', 8, 1, 1, 'img1557402455.jpg'),
...
(16, 'Kolaborasi Codeigniter dan Ajax dalam Perancangan', 1, 'Anton Sabugia', 'Elex Media Komputindo', 2017, '43345356577', 5, 0, 0, 'img1557403502.jpg'),
...
(1, 'Tya Rantansari', '', 'tyarantansari@gmail.com', 'default.jpg', '$2y$10$x8d9hyXZ7.CKYqzEQ.P8EuAwDTRP6XQhqA6ei8dajTMpY/V1tPzPa', 2, 1, 1574652993),
(2, 'Tya Rantansari', '', 'tya_berrylover@yahoo.co.id', 'default.jpg', '$2y$10$GE2BShxVIuXSrWadbCeOo.6PUlvcDuiI4EAH9TSO9ZovFIZUOMg0.', 2, 1, 1575714603);
